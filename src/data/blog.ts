...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaTitle: 'How Much Does a Paver Patio Cost in Colorado? | Rock N Roll Stoneworks',
    metaDescription:
      'Paver patio costs in Colorado vary based on size, material, and design complexity. This guide breaks down what you can expect to pay and what drives the price.',
    excerpt:
...
The only way to get an accurate estimate for your specific project is an on-site consultation. Rock N Roll Stoneworks provides free estimates for all projects in our service area. Contact us to schedule your consultation.`,
  },
  {
    ...
    metaTitle: 'Gas Fire Pit vs. Outdoor Fireplace: Best Choice for Colorado | Rock N Roll Stoneworks',
    metaDescription:
      'Choosing between a gas fire pit and an outdoor fireplace for your Colorado backyard? This guide covers the key differences, costs, and considerations for each option.',
    excerpt:
...
Contact Rock N Roll Stoneworks for a free consultation on your fire feature project.`,
  },
  {
    ...
    metaTitle: 'Paver Maintenance Guide for Colorado Homeowners | Rock N Roll Stoneworks',
    metaDescription:
      'Keep your paver patio or driveway looking great year after year. This guide covers cleaning, re-sanding, sealing, and what to watch for in Colorado\'s climate.',
    excerpt:

      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-16 pb-20 lg:pb-28 pt-48">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 bg-gold-500 text-white font-display font-semibold text-[12px] tracking-[0.18em] uppercase hover:bg-gold-400 transition-colors duration-300 rounded-sm shadow-glow"
            >
              Begin Your Project
            </Link>
            <a

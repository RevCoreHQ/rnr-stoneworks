...
export const metadata: Metadata = generatePageMetadata({
  title: 'Project Gallery | Rock N Roll Stoneworks Colorado',
  description:
    'Browse our paver patio, fire pit, outdoor kitchen, and hardscape portfolio. Serving the Colorado Front Range. Free estimates.',
  path: '/gallery',
});
    ...
    <>
      <JsonLd
        data={[
          ...
          imageGallerySchema([
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f79ad0276fa9e41f562.png', alt: 'Custom paver patio and outdoor living space in Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f79b3d5f7b8e170b90f.png', alt: 'Belgard paver installation and hardscape project in Erie, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f79c625852f25e3df82.png', alt: 'Backyard paver patio transformation in Boulder, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f79b3d5f785f870b90e.png', alt: 'Premium hardscape installation with retaining walls in Erie, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f7987f0f2270255e7e1.png', alt: 'Outdoor kitchen and paver patio design in Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f79ad0276705741f561.png', alt: 'Stone veneer and paver walkway installation in Westminster, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f7987f0f205f855e7e0.png', alt: 'Fire pit and paver patio project in Longmont, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b90f795b89c789d1e7799c.png', alt: 'Complete outdoor living space with hardscape in Boulder, Colorado' },
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b41abbe8487c68ea7458e3.jpg', alt: 'Belgard paver patio and outdoor kitchen installation in Colorado' },
            ...
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b41abbbfc81f7607ecedf1.jpg', alt: 'Belgard paver patio and seat wall installation in Colorado' },
            ...
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b41abbeba487d1ff20d048.jpg', alt: 'Custom paver patio with built-in fire feature and seating area in Colorado' },
            ...
            { src: 'https://assets.cdn.filesafe.space/9Er0a3QxE3UXUVoCQNyS/media/69b41abbeba487271b20d047.jpg', alt: 'Complete outdoor living space with fire pit and paver patio in Colorado' },
